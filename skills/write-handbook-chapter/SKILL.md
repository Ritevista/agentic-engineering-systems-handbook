...
3. Draft content in this exact structure:
...
4. Add concise, mdBook-safe examples.
5. Add explicit verification and artifact expectations.
6. Update related references if needed.
